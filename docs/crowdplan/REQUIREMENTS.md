...
| --- | --- | --- | --- | --- |
| CP-01 | Product purpose and scope | 00 | Capture settled/flexible dimensions, collect constraints, evaluate feasibility and compromises, and reach consensus; recommendations are optional. | Not started |
| CP-02 | Dimension model | 02 | LOCKED, CONSTRAINED, and UNDECIDED are enforced by the engine; context-specific dimensions are supported. | Not started |
...
| CP-04 | Interpretation and ambiguity | 02,03 | Provider abstraction, Anthropic preference, validated output, deterministic fallback, and clarification before hard constraints. | Not started |
| CP-05 | Organizer authentication | 01 | Supabase Auth; email link/OTP sufficient; Google OAuth when configured. | Not started |
| CP-06 | Guest participation and access | 01,03 | Secure plan invitation, display name, no account requirement, plan-scoped RLS and optional account claim. | Not started |
...
| CP-08 | Availability | 02,03 | IDEAL/WORKS/NOT AVAILABLE, date and time ranges, hard exclusions, overlap and participant views. | Not started |
...
| CP-13 | Universal candidates | 02,04,06 | Normalized places/events/custom/travel candidates and component candidates with provenance. | Not started |
| CP-14 | Hard feasibility | 02,05 | Deterministic participant predicates and explicit violations; universal failure cannot rank as feasible. | Not started |
| CP-15 | Soft scores and fairness | 02,05 | Average/minimum satisfaction, hard/soft compromises, ideal count, budget and convenience distribution. | Not started |
| CP-16 | Structured explanations | 02,05 | Positives, compromises and hardViolations are generated from engine facts, never invented by an LLM. | Not started |
| CP-17 | Consensus and objections | 05 | Five reactions; reason for CANNOT do; confirm new hard constraints; honest alignment state. | Not started |
| CP-18 | Make This Work | 06 | Identify blockers, seek bounded minimal changes, show individual impacts, re-evaluate and ask focused questions. | Not started |
...
| CP-21 | Database | 01 | Normalized Supabase PostgreSQL, migrations, organizer/guest permissions and RLS. | Not started |
...
| CP-29 | Preferred stack and secrets | 00,01 | Inspect environment, prefer requested stack, use current docs, never hardcode or leak secrets. | Not started |
...
| CP-31 | Automated tests | 02,09 | All specified domain areas tested; meaningful failing-case assertions and release checks pass. | Not started |
...
| CP-33 | Production security | 01,04,09 | Keys, RLS, guest isolation, unsafe URLs/HTML, rate limits, schema validation and SSRF protection. | Not started |
...
| CP-35 | Git and deployment | 00,10 | Coherent commits, authenticated GitHub push when available, Vercel production, migrations and env. | Not started |
